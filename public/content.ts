export default {
  seo: {
    pageTitle: `Home`,
    pageDescription: `Reykr: BC-based electronic music producer & DJ blending electronic, hip-hop & psychedelic influences into captivating tracks.`,
    pageImage: `seoImage.png`,
  },
